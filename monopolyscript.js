...
const buyHouseBtn = document.querySelector(".buyHouse");
const buyHotelBtn = document.querySelector(".buyHotel");
const player1MoneySpan = document.querySelector(".player1 span");
const player2MoneySpan = document.querySelector(".player2 span");
const player1PropertiesDiv = document.querySelector(".player1 .propertiesDiv");
const player2PropertiesDiv = document.querySelector(".player2 .propertiesDiv");
const p1EndTurnBtn = document.querySelector(".p1EndTurn");
const p2EndTurnBtn = document.querySelector(".p2EndTurn");
...
const playerPosition = document.querySelectorAll(".playerPos");
function updateBoard() {
    playerPosition.forEach(pos => {
        pos.innerHTML = "";
    });
    const player1Tile = document.querySelector(`#tile${player1.playerTile}`);
    const player1Pos = player1Tile.querySelector(".playerPos");
    player1Pos.innerHTML += player1.icon;
    const player2Tile = document.querySelector(`#tile${player2.playerTile}`);
    const player2Pos = player2Tile.querySelector(".playerPos");
...
showCard.style.display = "none";
function showProperty(playerTileId) {
    const property = monopolyProperties[playerTileId];
    const rentPrice = property === null || property === void 0 ? void 0 : property.rent;
    const rentMultiplier = property === null || property === void 0 ? void 0 : property.rentMultiplier;
    ...
    // BUY CARD
    const buyProperty = document.querySelectorAll(`#buy${playerTileId}`);
...
const showBoughtCard = document.querySelector(".showBoughtCard");
showBoughtCard.style.display = "none";
// BUY CARD LOGIC
function playerBuyProperty(player, propertyId) {
    var _a, _b;
    const property = monopolyProperties[propertyId];
    const playerMoneySpan = document.querySelector(`#moneySpan${player.id}`);
    const playerPropertiesDiv = document.querySelector(`#propertiesDiv${player.id}`);
    if (player.money < ((_a = property.price) !== null && _a !== void 0 ? _a : 0)) {
        alert("You do not have enough money to buy this property.");
        return;
    }
    player.money -= (_b = property.price) !== null && _b !== void 0 ? _b : 0;
...
function addHoverEffectToBoughtProperties() {
    const boughtPropertyDivs = document.querySelectorAll(".boughtProperty");
    boughtPropertyDivs.forEach(div => {
        ...
        let rentPrice = property === null || property === void 0 ? void 0 : property.rent;
        let rentMultiplier = property === null || property === void 0 ? void 0 : property.rentMultiplier;
